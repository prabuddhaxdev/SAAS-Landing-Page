...
function Navbar({scrollY:number}) {

  return (
    <nav className={`flex items-center fixed transition-all duration-300 z-50 ${scrollY > 10
...
export default function Home() {
  ...
  const companyLogos = [
    ...
    { name: "eBay", url: "https://cdn.brandfetch.io/ebay.com/w/512/h/207/theme/dark/logo?c=1idUHx8H6bLgIdA4LYE" },
    { name: "Zapier", url: "https://cdn.brandfetch.io/zapier.com/w/512/h/207/theme/dark/logo?c=1idUHx8H6bLgIdA4LYE" },
    { name: "SoundCloud", url: "https://cdn.brandfetch.io/soundcloud.com/w/512/h/207/theme/dark/logo?c=1idUHx8H6bLgIdA4LYE" },
  ];
